...
public class LoginView {
	...
	public void login() {
		...
		idLabel.setBounds(40, 245, 80, 30); // 130, 200, 60, 30
		idLabel.setFont(rhelr);
		frame.add(idLabel);
		JTextField idBox = new JTextField(10);
		idBox.setBounds(105, 245, 250, 35); // 180, 200, 120, 30
		frame.add(idBox);
		...
		pwBox.setBounds(105, 310, 250, 35); // 180, 300, 120, 30
		frame.add(pwBox);
		
		// 로그인 버튼
		
		JButton loginBtn = new JButton(new ImageIcon(".\\img\\loginimg.png"));
		loginBtn.setBounds(67, 390, 300, 50); // 160, 550, 120, 30
		loginBtn.setFont(rhelr);
		frame.add(loginBtn);
		
		JButton signBtn = new JButton(new ImageIcon(".\\img\\signupimggray.png"));
		signBtn.setBounds(67, 450, 300, 50); // 160, 550, 120, 30
		frame.add(signBtn);

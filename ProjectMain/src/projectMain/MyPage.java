...
public class MyPage extends JFrame {
	...
	public MyPage() {
		...
		idLabel.setBounds(100, 200, 100, 20);
		...
		nameLabel.setBounds(100, 245, 100, 20);
			...
			if (file.exists()) {
				...
				while ((sLine = inFile.readLine()) != null) {
					...
					if (sLineInfo[0].equals(LoginService.idInfo)) {
						...
						if (num_count == 9) {
							movieName.setBounds(210, 380 + plus, 300, 20);
		...
		JToggleButton btn_input = new JToggleButton(new ImageIcon(".\\img\\mypage.png"));
